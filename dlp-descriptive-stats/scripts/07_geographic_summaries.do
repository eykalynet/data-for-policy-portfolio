...
replace region_label = "NCR" if region_label == "Region 15"
replace region_label = "Bicol" if region_label == "Region 5"
replace region_label = "Davao" if region_label == "Region 11"
replace region_label = "CALABARZON" if region_label == "Region 4"
replace region_label = "Central Visayas" if region_label == "Region 7"
gsort -n_schools
graph hbar control_schools treatment_schools, over(region_label, sort(n_schools) descending label(labsize(small) angle(45))) stack ///
...
graph hbar compliance_rate, over(region_label, sort(compliance_rate) descending label(labsize(small))) ///
    title("Implementation Rates by Region") ///
